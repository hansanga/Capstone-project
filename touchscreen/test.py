...
class ColorLog(QMainWindow, Main_Ui.Ui_ColorLog):
    ...
    def SelectBtn(self, btn_number):
        ...
        # 선택된 버튼 스타일 적용
        if btn_number == 1:
            self._select_button(self.select1, self.select_1, "#d9f1ff", 500, 330)
        elif btn_number == 2:
            self._select_button(self.select2, self.select_2, "#feffd9", 835, 330)
        elif btn_number == 3:
            self._select_button(self.select3, self.select_3, "#ded9ff", 1170, 330)
    ...
    def SelectFrame(self, frame_number):
        ...
        if frame_number == 1:
            self._select_frame(self.color1, 130, 400, 'spr')
        elif frame_number == 2:
            self._select_frame(self.color2, 390, 400, 'sum')
        elif frame_number == 3:
            self._select_frame(self.color3, 650, 400, 'fal')
    ...
    def _select_frame(self, frame, x, y, frame_result):
        ...
        self.finalPhoto2.setPixmap(QPixmap("final_photo.jpg").scaled(self.finalPhoto2.size(), Qt.KeepAspectRatio))
    ...
    def stop_camera(self):
        ...
        if self.cap:
            camera.release_camera(self.cap)
            self.cap = None
